...
function carregarRelatorioDRE() {
    const reportId = process.env.DRE_REPORT_ID;
    const groupId = process.env.DRE_GROUP_ID;
    const tenantId = process.env.DRE_TENANT_ID;
